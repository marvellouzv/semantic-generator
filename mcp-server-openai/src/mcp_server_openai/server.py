            ...
            types.Tool(
                ...
                inputSchema={
                    ...
                    "properties": {
                        ...
                        "model": {"type": "string", "default": "gpt-4", "enum": ["gpt-4", "gpt-3.5-turbo", "gpt-5", "gpt-5-mini", "gpt-5-thinking", "gpt-4o"]},
                        "temperature": {"type": "number", "default": 0.7, "minimum": 0, "maximum": 2},
                        "max_tokens": {"type": "integer", "default": 2000, "minimum": 1, "maximum": 8192}
                    },
                    "required": ["query"]
                }
            )
